...
import odontograma from "./assets/fotoOdontograma.png"


const PatientFicha = ({ patient }) => {

  if (!patient) { 
    return <p>No se ha seleccionado ningún paciente para mostrar su ficha.</p>;
  }

  return (
    <div>
      <h3>Ficha del Paciente: {patient.nombre}</h3>
      ...
      <img src={odontograma} className="odontograma" alt="odontograma-provisorio" />
    </div>
  );
};
